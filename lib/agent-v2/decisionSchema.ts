...
export type EvaluationDecision = { success: boolean; score: number; reason: string; missing?: string[]; nextAction?: PlannerDecision };
const MAX_TEXT = 2000;
...
export function validateEvaluationDecision(value: unknown, availableTools: string[]): EvaluationDecision {
